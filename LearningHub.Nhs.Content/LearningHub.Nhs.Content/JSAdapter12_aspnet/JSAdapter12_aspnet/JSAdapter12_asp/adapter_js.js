<!-- $Header: adapter_js.js 120.0.12010000.8 2022/07/28 09:08:06 smahanka noship $ -->
var queryParameters=null;
var sessionId=null;
function getLMSUrl()
{
   return getQueryParameter("LMS_URL");
}
...
function launchRco()
{
   ...
   for(var i=0;i<params.length;i++)
   {
      ...
      if(upperParamName!="STARTING_URL" && upperParamName!="SESSIONID" &&
         upperParamName!="LMS_URL" && upperParamName!="LMS_DEBUG" &&
         upperParamName!="LMS_SIGNED" && upperParamName!="LMS_LOG_DEBUG")
      {
