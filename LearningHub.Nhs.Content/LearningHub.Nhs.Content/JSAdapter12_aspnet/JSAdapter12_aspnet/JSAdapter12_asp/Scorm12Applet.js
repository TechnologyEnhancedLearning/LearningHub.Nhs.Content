<!-- $Header: Scorm12Applet.js 120.0.12010000.4 2020/11/02 06:24:13 smahanka noship $ -->
extend(Scorm12Applet,LMSApplet);
function Scorm12Applet(lmsUrl,attemptId,respId,respApplId,secGroupId,debug)
{
   this._initialize(lmsUrl,attemptId,respId,respApplId,secGroupId,debug);
}
Scorm12Applet.prototype._initialize=function(lmsUrl,attemptId,respId,respApplId,secGroupId,debug,requestTimeout)
{
   Scorm12Applet.superclass._initialize.call(this,lmsUrl,attemptId,respId,respApplId,secGroupId,debug,requestTimeout);
...
Scorm12Applet.prototype.buildExceptionsLookup=function()
{
   ...
   e.put(INVALID_VOCABULARY_CODE, new Array("405","Incorrect Data Type","Invalid vocabulary code.  Please report this error to the Learning Administrator."));
   e.put(INVALID_VOCABULARY_WORD, new Array("405","Incorrect Data Type","Invalid vocabulary code.  Please report this error to the Learning Administrator."));
